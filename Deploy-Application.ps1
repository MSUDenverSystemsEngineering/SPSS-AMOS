...
Try {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-MSI -Action "Uninstall" -Path "{5643F9D3-6B6B-439A-A8D1-66C0D363B553}" -AddParameters "ALLUSERS=1 REMOVE=`"ALL`"" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010"))  { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDi11cMPiPbSGDY
# uUz3+KvHMLb3sl0ScAx7kPywVhVnDqCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgshqvghmMXe7q
# nDG0Vyd7X3+1hKyBCmK3hpyBW94Q4egwDQYJKoZIhvcNAQEBBQAEggGAJfYrKZsz
# uhYhTI0p7VfbT0vUU+0p6iGRHh2cluBitDKmgscNI2dva3gW0eTohIp54c6a0APR
# hQVJQZmuk0Zb40tEbziIlDH2U/KB+N2os6wjeezEoI/RpNtsGSFHa/v6JmcC0Dgd
# psOAP18jhnG5Moh2OgeaIWRpxQI/GVYv4zDe0h4ICl8YKMToueuFCFqjFUct7pJ+
# hUipucdCN4U3zVnWD8RiWCF9NYvq5CywxkalK124+ks/oBANdZd/f7LZCo5Yael4
# IdfEQJPzwQVXERjMTB2yr7TKqt5BTe7YFaC83fkBFjPHWemEnaeMDYuHKTMOKolj
# 8a6/v5OtBpL8yRdo20ivdvwOXTKGkziraSNgFYNYVukwitWJGMDnZmPv4AZc1CI5
# vUwoQ1oosFPAFcyrGviyDi9Mea03GlzDWXjn2wQWAZtDz4bAxStu2qfesMi60d2y
# HnIggRN/ixRYX0GIv1RqMDmVQbthHIbLmEw0EeCjj6uT8VpprFiStzFSoYIDTDCC
...
# NTQyMDBaMD8GCSqGSIb3DQEJBDEyBDCXjC75mtXCF0kOLDwEJD6VElmkuTbOdbvS
# ptTWO+yzgq4sY7LXRuERdazTk2tS67QwDQYJKoZIhvcNAQEBBQAEggIADquzm+M8
# qx6wulT6Odm5S3hgbnz2iCVnlteX2qgoArXa6ZqvfmoTz1URGRuaRzn8sALR7syq
# +23YfMvjLeW9DAmqSnyRTMnJuBVLGjPozHs5VD9qknt7hDB66JZNPW6MiG1qMoBV
# s6+q7pqgWGh/JoXEgZNvnxeRvr4dpmTV1HPw1CKNsBkzWwxsfqf/T9FMjcESvbFp
# y/yhQASUR2Gti4rF5IWA3D7HwopkLU5Y0lTBR3ODmzIzoVd8SztZfIaOYxt09BZj
# IzOlxJcDa+fGjYqVtrgzGICtqZNJ+QOHrM0uGMw5GDEqGytuuETYlPlmAQ6tlNlR
# u6eQRbOu7qDcovF0OUJXli0nWkgTP590v05dvG2xsV6j66+ZE6ZPpN3uQNsEdaoo
# uf4A5XY43fIOc35eqdV+UKCIqeIPU73xQK+nId8eKCYOzk0Vq60E6d7QZ8EwQY84
# fClDtTGNqLZxOuJkiwxm82EezOvwl6iwtB5hfOmbfmw7zzOA6X1eedSF2/JwsiE4
# 9F0OOPzMMZw5GKY+geKdnhhsawca37FogISrKl6t6Mmsb11ytjxXhlgK/2eBah7T
# lBiV0ROlKPiAEZc2BVI2QYguiqnTCdshkXnA92oZJAjgUuPbvQX89aTqWTP6Dp8Z
# ptyy2i1lbYuM3t3pRozkEspVJcXyaj4G49U=

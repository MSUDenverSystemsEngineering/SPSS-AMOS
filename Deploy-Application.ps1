...
Try {
	...
	[string]$appName = 'SPSS Amos'
	[string]$appVersion = '29'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '04/03/2023'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'spss,amos,stats' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		Remove-MSIApplications -Name "Amos"
		#Amos 22 GUID {DEB57287-C937-4DE9-939A-5ED3AB8F052D}
		...
		$exitCode = Execute-MSI -Action "Install" -Path "IBM SPSS Amos 29.msi" -Transform "1033.MST" -Parameters "REBOOT=ReallySupress /QN LICENSETYPE=`"Network`" LSHOST=`"vmwas32.winad.msudenver.edu`" COMPANYNAME=`"Metropolitan State University of Denver`"" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'Amos,stats,spss' -CloseAppsCountdown 60
		...
		$exitCode = Execute-MSI -Action "Uninstall" -Path "{8E187325-A1A7-499D-A300-9A603E2CC2B6}" -AddParameters "ALLUSERS=1 REMOVE=`"ALL`"" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010"))  { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCztlSa2uksMrkJ
# Neq1WOxLK50qxBVbzrzxg6UjeCoajKCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg/3uvYN/Fi8D2
# K71QmAZJ8CTsvvotECMXeUCoTw2oiUIwDQYJKoZIhvcNAQEBBQAEggGAcPBOh3gi
# /THJ1NMzBVOqTQj1q0KdXue4AwAtSeYpPwDoxdetXMXNpv2rfXQ97rZx+Q7HGkNc
# ZEp26Camtlyw7VN8ptejbbUtDdJMXR8pggVcWQZV3k1dGWqVrOdfQd6Fm+8sOKX6
# v398D9JeDY2Ju1/WBRH091ndEey6Qfk6Q7P/la8daFwd7RmQ3bIKt9njbWVzpdFZ
# nyS9wikccKs8SgA5eHyn61DjIkdlh2EnkSZaFSmC/XoOUjd/eMo9LTS+ZcEqDFF4
# 9YMabWy4QzOk/vo39ufelMwGs7VSwV17rORPgOv5nnl9SZQiKYV5JqeRdo/Oad+S
# /7W4izm85vmelSnRD/fBi0kp5AONniDMl/ZpvfWm3igP09YaJGCCUqeTLH4aUqwr
# OESeVN+zjIlSCwMgQNHF8wfoI9Vod6I/cV+R1XEiSYULjMJ/2vMC4Y7WUuwkpvu1
# XvZVULlMece9J0C5lZY19guKatK6Ke4Wv9HOWlqFkcpjriMRZQ2C3MlJoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzA0MDMx
# NzA2MzNaMD8GCSqGSIb3DQEJBDEyBDC5B43rAI8ElB+fYZinO8cROI9A/FDW532t
# Myig2SzBIavHk5ZSMmoEhZexDlIxogEwDQYJKoZIhvcNAQEBBQAEggIAgc2/Hkgc
# suNecu0N+aTGiBho3SlUfSoM76P6+XngKtzH0iwZnsrg3S9LzBF0hrMBt1W3uCAz
# H955cjWjzTt/KdViWAIblIuClbOMYx76o2R+yqIxVG9pfTkgAW2OqJVUCSNV0GF1
# vFZE0s5Yr00CTSfiQIZuTp4JeAqsIpYc4hmWMTc0Dd2SFMWATYN3lYjWyispVgiC
# hN4CNmlgSdRvrwFzre/dsDp6iSN/XT7cTeMsNFFryPoNGAEppjvP9OM5spL52n5K
# N8dMQhZdra46wR+Ipv01YnYuOPtByGN/AqbeFZoHtCcrd3C1VPAoCcJHBfiCmSrr
# SD5TdUrYlAfrLFcVWygPVM6OaH6kp3R9+PiVESHs3WVL3il7oE8tlkjZKgppErYy
# v0qM5Lq6lrSEI0PMglwlNHi9PF9Ftg/qp2gVtiH2wbtiuXGV2efPBFkJ8HC0KLqo
# aGOkLQZG2cvoC0Cp5OByHvQXBaYd7IIr1dWA3eyOVLxQQUm9wo+MPBWnwbb6nFCa
# ff4XOnJmGBcaPSQfJ4KvK7hOf8/3XFn9+0pX2La/2CZ8t7rfOuuLsyMa2IEQ/B79
# mXLyaMtB9hCZtAQ2FmLQx7ovCOAgTf5pOB9ylXrEtBfK7FktV9kEKxyZ8Ub7MsaL
# jmdlcKQrW3C67pIZtRqNF3cOBc6Q5R1/U14=

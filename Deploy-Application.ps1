...
Try {
	...
	[string]$appScriptDate = '07/26/2021'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-MSI -Action "Install" -Path "IBM SPSS Amos 28.msi" -Transform "1033.MST" -Parameters "REBOOT=ReallySupress /QN LICENSETYPE=`"Network`" LSHOST=`"vmwas32.winad.msudenver.edu`" COMPANYNAME=`"Metropolitan State University of Denver`"" -PassThru

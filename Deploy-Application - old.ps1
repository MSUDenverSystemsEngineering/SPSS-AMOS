...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$productCodes = @("{304B71E3-1017-4717-86BC-F1D18519FEF2}","{58C50F5A-B7E2-4149-8911-B14CEC825F57}","{B132EFD2-BF03-48AA-8EC8-404E4C5199C5}","{65D9DA69-4C22-46CA-B762-A338CAC94599}","{9DB2E18E-2A1F-4D65-A258-9CB446903C3E}","{4DA782CB-C9A0-462F-9D18-17D301BC507C}")
		...
		$exitCode = Execute-MSI -Action "Install" -Path "IBM SPSS Amos 22.msi" -Transform "1033.MST" -Parameters "REBOOT=ReallySupress /QN LICENSETYPE=`"Network`" LSHOST=`"vmwas22.winad.msudenver.edu`" COMPANYNAME=`"Metropolitan State University of Denver`"" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) {
			$mainExitCode = $exitCode.ExitCode
		}
		##*===============================================
		...
		Copy-File -Path "$dirSupportFiles\spssprod.inf" -Destination "$envProgramFilesX86\IBM\SPSS\Amos\22"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-MSI -Action "Uninstall" -Path "{DEB57287-C937-4DE9-939A-5ED3AB8F052D}" -AddParameters "ALLUSERS=1 REMOVE=`"ALL`"" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) {
			$mainExitCode = $exitCode.ExitCode
		}
		##*===============================================
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZ74yZo2ZXOmZl
# qrLFZz2f53z6LDhZ4SkSu1UQNBtosqCCGdcwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BDEiBCCuOqxgGCxmgUuu6kEaw3+ykS05lgfLRNJKG0tZI70n4jANBgkqhkiG9w0B
# AQEFAASCAQCX8T1e6HBhtA0O7neMAt8OKCwhQC/xbwG1Gypl8vv7X+PW10CgkSAw
# lOz7TZo2PWheKRsPbls6ZwbJIBnigWvo5K6voGFegYQXPDMS17LreTQruL9fBcXN
# kTJD4o1d/ZA+I5tTLo8vAdIIqoEVGlShmy/n1icrN4NMG8Dg/TbbCcfaKZCj7fwS
# T5C+Ks66IyoOx9zLNY1tF+MekdddVPaLhKIRB1TIioXS5Fm9G6az68EA7m0huTDt
# mt5HGNZ+v8lyBLT4Yv9zNk0mVcC0bDimYaOHEXB/jRJ06Mw421Jsd2G3fNuoksan
# zXCJX7y9KQ9TZCWg2f9xHn5Go26JckrToYICojCCAp4GCSqGSIb3DQEJBjGCAo8w
# ggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# 1pmnZJc+8fhCfukZzFNBFDAJBgUrDgMCGgUAoIH9MBgGCSqGSIb3DQEJAzELBgkq
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE4MDYyMTIzMjgzMFowIwYJKoZIhvcN
# AQkEMRYEFB1piQSy5MFumZ0ImEfJ4ogSdbBXMIGdBgsqhkiG9w0BCRACDDGBjTCB
# ijCBhzCBhAQUY7gvq2H1g5CWlQULACScUCkz7HkwbDBWpFQwUjELMAkGA1UEBhMC
# QkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNp
# Z24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh1pmnZJc+8fhCfukZzFNBFDANBgkq
# hkiG9w0BAQEFAASCAQBthPUmG1rGqmd8/jtDxIozwCgig8VR70NTSvrrFFpcLMDr
# JqT4rb6ypOEsyO/5yv45T0ky8gN1JiAADKAWQ29lFM0zQpvvmAeWEmd1NTQmsPu8
# Lm7WwQYdOS6KehSK7jKiunewShTmyCL/EhxhIBKXSUrz9/LxMbq8X77fLGKliqQo
# dwk0as2aztjCi9zBBLF3p1/qL+jZB8bnF2CuiAYAnj+OV5myLycQQgBGnFDDe+QM
# ikq701hxxT1s1FKSspLDQyfqUn7eWsDrgr2k5pM86GqWmT5bYThEq3WMhMXbjole
# U4TfPn408NgbKkOYNMM0Wia63DbYRlWhFWmllTku

...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses spss, amos, stats -CheckDiskSpace -PersistPrompt

    ## Show Progress Message (with the default message).
    Show-ADTInstallationProgress

    ## <Perform Pre-Installation tasks here>
    Uninstall-ADTApplication -Name "Amos" -ApplicationType 'MSI'
    ...
    $exitCode = Start-ADTMsiProcess -Action 'Install' -FilePath "IBM SPSS Amos 30.msi" -Transforms "1033.MST" -ArgumentList "REBOOT=ReallySupress /QN LICENSETYPE=`"Network`" LSHOST=`"vmwas32.winad.msudenver.edu`" COMPANYNAME=`"Metropolitan State University of Denver`"" -PassThru
...
function Uninstall-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses spss, amos, stats -PersistPrompt
    ...
    $exitCode = Start-ADTMsiProcess -Action "Uninstall" -ProductCode "{53127D38-7A86-4EB9-BBB6-9239EE679396}" -ArgumentList "/QN ALLUSERS=1 REMOVE=`"ALL`"" -PassThru
    If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
